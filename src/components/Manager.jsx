...
theme="light"
/>
    <div className='max-w-[900px] h-[670px] mx-auto px-4 rounded-3xl'>
    <div className='w-full m-auto text-center pt-4'>
...
>
  ...
  Save
    ...
    <div className="mt-2 h-[350px] overflow-auto custom-scrollbar p-2">
